...
export async function listDeveloper(params) {
  return request('/api/developer/list', {
    method: 'POST',
    body: params,
...
export async function deleteApp(params) {
  return request(`/api/developer/${params.id}`, {
    method: 'DELETE',
    headers: { token: sessionStorage.getItem('token') },
  });
}
...
export async function get(params) {
  return request('/api/developer/get', {
    method: 'POST',
    body: params,
    headers: { token: sessionStorage.getItem('token') },
  });
...
export async function listDeveloperAllApp(params) {
  return request(`/api/app/list/developer/${params.developerId}`, {
    method: 'GET',
    headers: { token: sessionStorage.getItem('token') },
  });
}
